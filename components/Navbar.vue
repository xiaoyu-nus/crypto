      ...
      >
        <div class="flex flex-wrap items-center space-x-8">
          <NuxtLink href="#" class="flex items-center">
            ...
            />
            <span
              class="self-center text-xl font-semibold whitespace-nowrap text-gray-100"
              >Mainnet Digital</span
            >
          </NuxtLink>
          <button
          ...
          <div class="hidden w-full lg:block md:w-auto" id="navbar-dropdown">
            ...
            >
              <li>
                <a
                  href="#"
                  class="block py-2 pl-3 pr-4 text-gray-300 bg-blue-700 rounded md:bg-transparent md:text-blue-500 md:p-0"
                  aria-current="page"
                  >Wallets</a
                >
              </li>
              <li>
                <a
                  href="#"
                  class="block py-2 pl-3 pr-4 text-gray-300 bg-blue-700 rounded md:bg-transparent md:text-gray-300 md:p-0 md:hover:text-blue-500"
                  aria-current="page"
                  >Markets</a
                >
              </li>
              <li>
                <button
                  ...
                  class="flex items-center justify-between w-full py-2 pl-3 pr-4 text-gray-300 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 md:w-auto dark:text-white"
                >
                  Control Panel
                  <svg
                    class="w-5 h-5 ml-1"
